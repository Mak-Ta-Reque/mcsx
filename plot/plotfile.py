...
# Create an empty DataFrame with the defined columns
    ...
    for j in range(len(x_test[2:4])):
        ...
        for i in range(len(run.explanation_methodStrs)):
            ...
            #fig.savefig('/home/goad01/save_images_mcsx/77/original_image '+str(j)+'.png',bbox_inches='tight',pad_inches=0)
            ...
            print(sample.shape)
            ax.imshow(sample[0].permute(1, 2, 0).detach().cpu().numpy(), interpolation='none', cmap='gray', alpha=1.0)
            #fig.savefig('/home/goad01/save_images_mcsx/77/triggered_image '+str(j)+'.png',bbox_inches='tight',pad_inches=0)
            ...
            for man_id in range(run.num_of_attacks):
                ...
                #fig.savefig('/home/goad01/save_images_mcsx/77/exp_ts_mm '+str(j)+'.png',bbox_inches='tight',pad_inches=0)
